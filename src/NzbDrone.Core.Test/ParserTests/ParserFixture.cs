...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class ParserFixture : CoreTest
    {
        ...
        [TestCase("2.Tage.in.L.A.1996.GERMAN.DL.720p.WEB.H264-SOV", "2 Tage in L.A.", "", 1996)] //edition after year
        [TestCase("8.2019.GERMAN.720p.BluRay.x264-UNiVERSUM", "8", "", 2019)] //edition after year
