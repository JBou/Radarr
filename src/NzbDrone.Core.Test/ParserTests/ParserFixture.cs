...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class ParserFixture : CoreTest
    {
        ...
        [TestCase("The.Italian.Job.2003.German.DTS.1080p.Bluray.x264-w0rm", 4, Description = "German")]
        [TestCase("Loving.Pablo.2018.TS.FRENCH.MD.x264-DROGUERiE", 2, Description = "French")]
        [TestCase("Der.Film.deines.Lebens.German.2011.PAL.DVDR-ETM", 4, Description = "German")]
        [TestCase("Alice.In.Wonderland.2010.iTALiAN.720p.BluRay.x264-FAVELAS", 5, Description = "Italian")]
